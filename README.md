...
Published Scope: 
Streaming and analysis: SIGCOMM, NSDI, MobiCom, MobiSys, INFOCOM, MM, VR, IMC, CoNEXT, WWW, MMSys, OSDI, SOSP, NOSSDAV, 
Video processing: CVPR, ECCV, ICCV, TCSVT, TMM, ToG, TVCG, TIP
...
## Datasets
* [360-Degree Video Dataset](https://github.com/360VidStr/A-large-dataset-of-360-video-user-behaviour): A comprehensive 360-degree video dataset (88 videos)
